"""
Django settings for change_lives1 project.
...
SECRET_KEY = 'django-insecure-ehmd@lsan65^)lzb$unl9rd6afct*c6i1j!*6eir_*+5eowuop'
...
ROOT_URLCONF = 'change_lives1.urls'
...
WSGI_APPLICATION = 'change_lives1.wsgi.application'
